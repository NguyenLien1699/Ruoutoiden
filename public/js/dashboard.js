require.config({
    ...
    paths: {
        'core': '/js/core',
        'jquery': 'https://cdn.jsdelivr.net/jquery/latest/jquery.min',
        ...
        'confirm': 'https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.2/jquery-confirm.min',
        'moment' : 'http://cdn.jsdelivr.net/momentjs/latest/moment.min',
        'daterangepicker' : 'https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min',
        'datatable' : 'https://cdn.datatables.net/1.10.25/js/jquery.dataTables.min'
    }
});
window.tabler = {
colors: {

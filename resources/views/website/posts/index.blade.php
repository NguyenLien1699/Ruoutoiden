        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    <a href="{{ route('website.posts.create') }}" class="btn btn-primary btn-sm">Thêm bài viết</a>
                </div>
            </div>
                        ...
                        @if(isset($data) && count($data) > 0)
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('website.posts.edit',['id' => $item->id]) }}" class="btn btn-sm btn-secondary">
                                            <span class="fe fe-edit-2"></span>
                                        </a>
                                        <a href="{{ route('website.posts.delete',['id' => $item->id]) }}" class="btn btn-sm btn-secondary">
